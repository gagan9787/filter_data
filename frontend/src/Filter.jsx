...
//   // Source data from API (objects with id, name, etc.)
...
//   // Selected filters (arrays of strings)
...
//   const handleFilterChange = (category, value, slug) => {
...
//     const category = Object.keys(sourceData).find(key =>
...
//     } else {
//       console.log('No matching slug found in any category.');
//     }
//   }
//   get_universities(category);
// }, [params.slug]);

//   // FilterSection component for rendering filter checkboxes
...
//             <FilterSection title="Accepted Exam" items={sourceData.exam} category="exam" />
//             <FilterSection
//               title="Program Type"
//               items={sourceData.program_type}
//               category="program_type"
//             />
//             <FilterSection
//               title="College Type"
//               items={sourceData.college_type}
//               category="program_type"
//             />
//           </div>
//           <div className="right">
